EXPERIMENT = "LUM_aggreg" # label for your run, pick something short but descriptive without spaces and valid as part of a filename
...
REQUEST_MEMORY = 20000 # memory (MiB) to reserve for each job
...
SCRIPT = "./codes/agg_100to1km_LUM_cluster.R"
ARGUMENTS = "%1" # arguments to the script
BUNDLE_INCLUDE_DIRS = c("input") # recursive, supports wildcards
BUNDLE_EXCLUDE_DIRS = c(BUNDLE_EXCLUDE_DIRS, "Condor", "output", "input/N2K", "input/N2K") # recursive, supports wildcards
